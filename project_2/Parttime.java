...
public class Parttime extends Employee {
    ...
    /**
     * This method is a constructor for partime
    ...
    public String toString() {   
        ...
        String textualRepresentation = (super.toString() + "::Payment " + dec.format(paymentAmt) + "::PART TIME::Hourly Rate " 
    ...
    public void calculatePayment() { 
        if (workingHours > 80) {
            ...
            paymentAmt = (hourlyPay * workingHours) + excessWage;  
        }
        else {
            paymentAmt = hourlyPay * workingHours;   
        }
    }
}
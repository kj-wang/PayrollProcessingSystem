...
public class Management extends Fulltime {
    ...
    */
    ...
    public void calculatePayment() { 
        if (role == MANAGER) {
            super.payment = (super.salary / PAYMENT_PERIOD) + MANAGER_COMPENSATION;
        }
        else if (role == DEPARTMENT_HEAD) {
            super.payment = (super.salary / PAYMENT_PERIOD) + DEPARTMENT_HEAD_COMPENSATION;
        }
        else if (role == DIRECTOR) {
            super.payment = (super.salary / PAYMENT_PERIOD) + DIRECTOR_COMPENSATION;
        }
    }
}
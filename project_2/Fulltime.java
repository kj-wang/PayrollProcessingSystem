...
public class Fulltime extends Employee {
    ...
    public String toString() { 
        ...
        String textualRepresentation = (super.toString() + "::Payment " + dec.format(payment) + "::FULL TIME::Annual Salary " + dec.format(salary));
    ...
    public void calculatePayment() { 
        this.payment = this.salary / PAYMENT_PERIOD; 
    }
}
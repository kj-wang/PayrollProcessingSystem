    ...
    private Employee[] sortByDepartment(){
        ...
        for(int i = 0; i < numEmployee - 1; i++){
            ...
            for(int j= i + 1; j < numEmployee; j++){  
                String depart1 = sortedArr[j].profile.getDepartment();
                String depart2 = sortedArr[min].profile.getDepartment();
                if(depart1.compareTo(depart2) > 0){
                    min = j;
                }
            }           
    ...
    */
    private Employee[] sortByDate(){
        ...
        for(int i = 0; i < numEmployee - 1; i++){
            int old = i;
            for(int j= i + 1; j < numEmployee; j++){ 
                Date datePtr = sortedArr[j].profile.getDateHired();
                Date dateOld = sortedArr[old].profile.getDateHired();
    ...
    /**
     * This method prints the earning statments for all employees in no particular order
     */
    ...
    public void printByDepartment() { 
        ...
        for(int i = 0; i < numEmployee; i++){ 
            System.out.println(depSorted[i].toString());
        }
    } 
    ...
    public void printByDate() { 
        ...
        for(int i = 0; i < numEmployee; i++){ 
            System.out.println(dateSorted[i].toString());
        }
    } 
